...
export const modalHeading =
  'text-2xl font-extrabold text-center text-primary drop-shadow-sm';
...
const buttonBase =
  'px-4 py-2 rounded-2xl hover:shadow-glow transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring';
