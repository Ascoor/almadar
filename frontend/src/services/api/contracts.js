...
export const getContractById = (id, config = {}) =>
  api.get(`/api/contracts/${id}`, config);
...
export const getContractCategoryById = (id) =>
  api.get(`/api/contract-categories/${id}`);

export const createContractCategory = (data) =>
  api.post('/api/contract-categories', data);

export const updateContractCategory = (id, data) =>
  api.put(`/api/contract-categories/${id}`, data);

export const deleteContractCategory = (id) =>
  api.delete(`/api/contract-categories/${id}`);
